...
/*
//================
//idBaseMultiplayer::idBaseMultiplayer
//================
idBaseMultiplayer::idBaseMultiplayer()
{
  // Nicemice: done
...
//idBaseMultiplayer::~idBaseMultiplayer
//================
void idBaseMultiplayer::Shutdown()
{
  // Nicemice: done
  Clear();
}
...
//================
//idBaseMultiplayer::Run
//================
void idBaseMultiplayer::Run()
{
  // Nicemice: undone
}

//================
//idBaseMultiplayer::ServerClientConnect
//================
void idBaseMultiplayer::ServerClientConnect( int clientNum )
{
  // Nicemice: undone
}

//================
//idBaseMultiplayer::DisconnectClient
//================
void idBaseMultiplayer::DisconnectClient( int clientNum )
{
}

//================
//idBaseMultiplayer::SpawnPlayer
//================
void idBaseMultiplayer::SpawnPlayer( int clientNum )
{
  // Nicemice: undone
}

//================
//idBaseMultiplayer::IsPureReady
//================
bool idBaseMultiplayer::IsPureReady() const
{
  // Nicemice: undone
  return true;
}
...
//================
//idBaseMultiplayer::PlayerDeath
//================
void idBaseMultiplayer::PlayerDeath(idPlayer* dead,idPlayer* killer,bool telefrag)
{
  // Nicemice: undone
}

//================
//idBaseMultiplayer::Precache
//================
void idBaseMultiplayer::Precache( void )
{
  // Nicemice: undone
}

//================
//idBaseMultiplayer::Draw
//================
bool idBaseMultiplayer::Draw( int clientNum )
{
  // Nicemice: undone
  return true;
}
...
//================
//idBaseMultiplayer::EnterGame
//================
void idBaseMultiplayer::EnterGame( int clientNum )
{
  // Nicemice: undone
}

//================
//idBaseMultiplayer::UpdateMainGui
//================
void idBaseMultiplayer::UpdateMainGui()
{
  // Nicemice: undone
}

//================
//idBaseMultiplayer::StartMenu
//================
idUserInterface* idBaseMultiplayer::StartMenu()
{
  // Nicemice: undone
  return NULL;
}
...
//================
//idBaseMultiplayer::HandleGuiCommands
//================
const char* idBaseMultiplayer::HandleGuiCommands( const char *menuCommand )
{
  // Nicemice: undone
  return "";
}
...
//================
//idBaseMultiplayer::SetMenuSkin
//================
void idBaseMultiplayer::SetMenuSkin()
{
  // Nicemice: undone
}

//================
//idBaseMultiplayer::WriteToSnapshot
//================
void idBaseMultiplayer::WriteToSnapshot( idBitMsgDelta &msg ) const
{
  // Nicemice: undone
}

================
idBaseMultiplayer::ReadFromSnapshot
================
void idBaseMultiplayer::ReadFromSnapshot( const idBitMsgDelta &msg )
{
  // Nicemice: undone
}

================
idBaseMultiplayer::ProcessChatMessage
================
void idBaseMultiplayer::ProcessChatMessage(int clientNum,bool team,const char* name, const char* test,const char* sound)
{
  // Nicemice: undone
}

================
idBaseMultiplayer::AddChatLine
================
void idBaseMultiplayer::AddChatLine( const char *fmt, ... )
{
  // Nicemice: undone
}

================
idBaseMultiplayer::Init()
================
void idBaseMultiplayer::Init()
{
  // Nicemice: undone, initialize the multiplayer mode
}

================
idBaseMultiplayer::Clear()
================
void idBaseMultiplayer::Clear()
{
  // Nicemice: undone, clean up the multiplayer mode
}
*/
