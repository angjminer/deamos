...
#define GAME_NAME						"deamos"		// appears on window titles and errors

#define ENGINE_VERSION					"deamos 1.3.1"	// printed in console

// paths
#define	BASE_GAMEDIR					"base"

// filenames
#define CONFIG_FILE						"deamos.cfg"
...
// Linux info
#define LINUX_DEFAULT_PATH				"~/deamos"
