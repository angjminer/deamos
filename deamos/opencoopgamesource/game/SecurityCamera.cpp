...
void idSecurityCamera::Event_AddLight( void ) {
  ...
  // Nicemice: FIXME
  // this event must not be executed on a client
  // (since it spawns an entity), lets see if it does
  if ( gameLocal.isClient )
  {
    gameLocal.Warning("coop: idSecurityCamera::Event_AddLight unhandled");
  }
