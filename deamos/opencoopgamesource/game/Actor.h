...
public:
	...
	// Nicemice: DEBUG
	 bool AnimDoneTest( int blendFrames ) const; 
...
protected:
  ...
  // Nicemice: added
  enum {
    EVENT_ACTOR_ANIMSTATE = idAFEntity_Gibbable::EVENT_MAXEVENTS,
    EVENT_ACTOR_SETANIMPREFIX,
    EVENT_ACTOR_FINISHACTION,
    EVENT_ACTOR_IDLEANIM,
    EVENT_ACTOR_OVERRIDEANIM,
    EVENT_ACTOR_PLAYANIM,
    EVENT_ACTOR_PLAYCYCLE,
    EVENT_ACTOR_SETBLENDFRAMES,
    EVENT_ACTOR_STOPANIM,
    EVENT_MAXEVENTS
	};
