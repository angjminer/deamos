...
/*
================
idTrigger_Multi::CheckFacing - Nicemice: modified
================
*/
...
/*
================
idTrigger_EntityName::idTrigger_EntityName - Nicemice: modified
================
*/
...
/*
================
idTrigger_Timer::Event_Use - Nicemice: modified
================
*/
...
/*
================
idTrigger_Count::idTrigger_Count - Nicemice: modified
================
*/
...
/*
================
idTrigger_Hurt::ReadFromSnapshot - Nicemice: added
================
*/
void idTrigger_Hurt::ReadFromSnapshot( const idBitMsgDelta &msg ) {
...
/*
================
idTrigger_Hurt::WriteToSnapshot - Nicemice: added
================
*/
void idTrigger_Hurt::WriteToSnapshot(idBitMsgDelta &msg) const {
...
/*
================
idTrigger_Fade::idTrigger_Fade - Nicemice: added
================
*/
...
/*
================
idTrigger_Fade::ClientReceiveEvent - Nicemice: added
================
*/
bool idTrigger_Fade::ClientReceiveEvent(int event,int time,const idBitMsg &msg) {
  
  switch (event)
  {
  case EVENT_TRIGGER_FADE: {
    Event_Trigger(NULL);
    return true;
    }
  };
  return idTrigger::ClientReceiveEvent(event,time,msg);
}
...
void idTrigger_Touch::Spawn( void ) {
  idStr testname;
  spawnArgs.GetString("name", "", testname );
  gameLocal.Printf("idTrigger_Touch::Spawn : ");
  gameLocal.Printf(testname);
  gameLocal.Printf("\n");
