...
/*
================
idEntityFx::StartFx - Nicemice: modified
================
*/
idEntityFx *idEntityFx::StartFx( const char *fx, const idVec3 *useOrigin, const idMat3 *useAxis, idEntity *ent, bool bind ) {
  ...
  // Nicemice: added
  // we don't allow spawning fx effects on the client
  if ( gameLocal.isClient ) {
    return NULL;
  }
...
/*
=================
idEntityFx::WriteToSnapshot - Nicemice: modified
=================
*/
...
/*
=================
idEntityFx::ReadFromSnapshot - Nicemice: modified
=================
*/
...
/*
================
idTeleporter::Event_DoAction - Nicemice: modified
================
*/
